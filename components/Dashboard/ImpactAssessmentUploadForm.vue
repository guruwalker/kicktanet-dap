...
const { uploadImpactAssessment } = useSupabaseImpactAssessment();
...
const handleUpload = async () => {
  ...
  try {
    const uploadedFiles = await uploadImpactAssessment(
      selectedFiles.value,
    ...
    <UCard>
      <template #header>
        <div class="flex justify-between items-center">
          <h2 class="text-lg font-semibold">Upload Impact Assessment</h2>
          <button
            @click="emit('close')"
