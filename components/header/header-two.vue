...
<template>
  <header class="header-area p-relative">
    <div
      id="header-sticky"
      :class="`tp-header-2 ${transparent ? 'tp-header-transparent' : ''} ${
        ...
        <div class="row align-items-center">
          <div class="col-xxl-3 col-xl-3 col-lg-6 col-6">
            <div class="tp-header-2-right d-flex align-items-center">
              ...
              <div
                class="tp-header-2-category tp-header-inner-category home-2 d-none d-md-block"
              >
                <nuxt-link
                  class="tp-header-2-category-icon"
                  href="/course-with-sidebar"
                >
                  <p>
                    <span><svg-dots /></span>Category
                  </p>
                </nuxt-link>
                <div class="tp-header-2-category-list">
                  <ul>
                    <li>
                      <nuxt-link href="/course-with-sidebar"
          ...
          <div class="col-xxl-3 col-xl-2 col-lg-6 col-6">
            <div
              class="tp-header-2-contact d-flex align-items-center justify-content-end"
            >
              ...
              <div
                :class="`tp-header-inner-btn ${
                  inner ? '' : 'home-2'
                } d-none d-xxl-block`"
              >
                <nuxt-link class="tp-btn-inner" href="/course-with-filter"
  ...
  <!-- search popup -->
  <popup-search
    :is-search-open="openSearchPopup"
    @update:search-open="handleSearchPopup"
  />
  <!-- search popup -->
  ...
  <!-- cart mini area -->
  <offcanvas-cart-mini
    :open-sidebar="cartMiniOpen"
    @show-sidebar="handleCartMini"
  />
  <!-- cart mini area -->
</template>
