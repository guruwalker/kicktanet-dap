...
<template>
  <UForm @submit.prevent="handleSubmit" :state="profileFormState">
    ...
    <UFormGroup class="py-3" label="Username" name="username">
      <UInput v-model="profileFormState.username" />
    </UFormGroup>

    <UFormGroup class="py-3" label="Email" name="email">
      <UInput v-model="profileFormState.email" />
    </UFormGroup>
    ...
    <UFormGroup class="py-3" label="Account ID" name="account_id">
      <UInput v-model="profileFormState.account_id" />
    </UFormGroup>

    <UFormGroup class="py-3" label="Family ID" name="family_id">
      <UInput v-model="profileFormState.family_id" />
    </UFormGroup>
