                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Jonathan Barnes</h6>
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <!-- Team Member Data -->
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Jaime Fletcher</h6>
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <!-- Team Member Data -->
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Les Bakker</h6>
                                <p class="color--grey">Software Engineer</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <!-- Team Member Data -->
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Alyssa Garrison</h6>
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <!-- Team Member Data -->
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Charlotte Johnson</h6>
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <!-- Team Member Data -->
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Olivia Steiner</h6>
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <!-- Team Member Data -->
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Charles Fairless</h6>
                    ...
                    <div class="col">
                        <div class="team-member mb-50 animate__animated animate__fadeInUp">
                            ...
                            <!-- Team Member Data -->
                            <div class="team-member-data">
                                <h6 class="s-20 w-700 color--theme">Grow with Us!</h6>
