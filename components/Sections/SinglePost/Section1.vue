          ...
          <div class="post-content">
            ...
            <div class="blog-post-img py-50">
              <img
                ...
                src="/assets/images/blog/post-12-img.jpg"
                alt="blog-post-image"
              />
            </div>
            <!-- SINGLE POST TEXT -->
            <div class="single-post-txt">
              ...
              <ul class="simple-list long-list">
                <li class="list-item">
                  <p>
                    ...
                    suscipit egestas magna ipsum and vitae efficitur purus and
                ...
                <li class="list-item">
                  <p>
                    Blandit velna vitae auctor and congue magna tempor sapien
                    eget gravida laoreet turpis
                  </p>
                </li>
                <li class="list-item">
                  <p>
                    Quaerat sodales sapien undo
                    <a href="#" class="color--theme">create an API Key</a>
                    blandit velna vitae auctor and congue magna tempor sapien
                    eget gravida laoreet turpis urna augue, viverra a augue eget
                    tempor diam
                  </p>
                </li>
              </ul>
              ...
              <div class="txt-code r-06">
                <p>
                  ...
                  <kbd>cd</kbd> consectetur vel imperdiet dui varius. Purus
              ...
              <div class="post-inner-img">
                <div class="video-preview">
                  ...
                  <img
                    class="img-fluid r-16"
                    src="/assets/images/blog/post-13-img.jpg"
                    alt="video-preview"
                  />
                </div>
              </div>
              ...
              <figure>
                <blockquote class="blockquote w-300">
                  <p>
                    ...
                    felis a congue tempor gravida habitant morbi and tristique
                    senectus netus malesuada famesa an augue luctus suscipit
                    sapien neque undo purus neque dolor primis sodales dapibus
                    egestas volute".
                  </p>
                </blockquote>
                <figcaption class="blockquote-footer">
                  ...
                  <cite title="Source Title"
                    >Engineering Manager, Company Name</cite
                  >
                </figcaption>
              </figure>
              <!-- Text -->
              ...
              <div class="txt-code r-06">
                <p>
                  <code class="code-language-js">
                    <span>
                      <span class="code-variable">module</span>.
                      <span class="code-property">exports</span> = {
                    </span>
                    <br />
                    <span class="pl-30">
                      <span class="code-variable">content</span>: ['
                      <span class="code-string">./src/**/*.{ts,tsx,html}</span
                      >'],
                    </span>
                    <br />
              ...
              <div class="txt-code r-06">
                <p>
                  Quisque laoreet turpis <kbd>cmd</kbd> urna augue, viverra a
                  augue eget, dictum tempor diam in cubilia laoreet augue
                  egestas <kbd><kbd>Alt</kbd> + <kbd>F1</kbd></kbd> congue and
                  egestas volutpat egestas magna suscipit.
                </p>
              </div>
              <!-- Text -->
              <p>
              ...
              <div class="post-inner-img">
                <img
                  class="img-fluid r-16"
                  src="/assets/images/blog/post-14-img.jpg"
                  alt="blog-post-image"
                />
              </div>
              <!-- Text -->
            ...
            <div class="post-author py-100 x-border">
              ...
              <div class="post-author-txt">
                ...
                <p>
                  ...
                  turpis vitae raesent a varius dolor sagittis luctus placerat a
                  magna cursus congue magna nihil mpedit.
                </p>
                <!-- Follow Button -->
            ...
            <div class="post-comments">
              <div class="comments-wrapper">
                    ...
                    <div class="comment-meta">
                      ...
                      <span class="btn-reply ico-20">
                        <a href="#leave-comment"
                          ><span class="flaticon-reply-arrow"></span> Reply</a
                        >
                      </span>
                    </div>
                    <!-- Comment-1 Text -->
                    <p class="mb-40">
                      Ratione mollis undo risus aenean arcu lectus rutrum porta
                      primis and puruss augue luctus neque purus and ipsum neque
                      dolor primis libero tempus eget tempor ligula posuere
                      varius impedit enim tempor vitae pulvinar at congue
                      egestas vitae augue
                    </p>
                    <hr />
                    <!-- Nested Comment -->
                    <div class="comment d-flex">
                      ...
                      <div class="comment-body">
                        ...
                        <div class="comment-meta">
                          ...
                          <span class="btn-reply ico-20">
                            <a href="#leave-comment"
                              ><span class="flaticon-reply-arrow"></span>
                              Reply</a
                            >
                          </span>
                        </div>
                        <!-- Comment-2 Text -->
                        <p>
                          Etiam sapien magna at vitae pulvinar congue egestas
                          and undo pretium neque viverra porta suscipit ratione,
                          mollis risus a lectus aliquet
                        </p>
                      </div>
                    </div>
                    <!-- End Nested Comment -->
                ...
                <div class="comment d-flex">
                  <!-- Comment Avatar -->
                  <img
                    src="/assets/images/comment-author-3.jpg"
                    alt="comment-avatar"
                  />
                  <!-- Comment Body -->
                  <div class="comment-body">
                    ...
                    <!-- Comment Text -->
                    <p>
                      Porta ratione mollis risus aenean arcu lectus rutrum porta
                      primis and puruss augue luctus neque purus and ipsum neque
                      dolor primis libero tempus eget tempor ligula posuere
                      varius impedit enim tempor vitae pulvinar at congue an
                      augue egestas vitae
                    </p>
                  </div>
                  <!-- End Comment Body -->
                ...
                <div class="comment d-flex">
                  <!-- Comment Avatar -->
                  <img
                    src="/assets/images/comment-author-4.jpg"
                    alt="comment-avatar"
                  />
                  <!-- Comment Body -->
                  <div class="comment-body">
                    ...
                    <!-- Comment Text -->
                    <p>
                      Congue augue egestas integer velna purus undo purus magna
                      nec suscipit egestas magna and neque egestas a porta
                      ratione mollis risus lectus porta quisque lacus
                    </p>
                  </div>
                  <!-- End Comment Body -->
                </div>
