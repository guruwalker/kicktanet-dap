            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 order-first order-md-2">
                    <div class="hero-2-txt animate__animated animate__fadeInLeft">
                        <!-- Title -->
                        <h2 class="s-56 w-700 color--theme">Realize your digital potential with Martex</h2>
                        <!-- Text -->
                        ...
                        <div class="hero-digits">
                            ...
                            <div id="hd-1-1" class="animate__animated animate__fadeInUp">
                                <div class="hero-digits-block">
                                    ...
                                    <div class="block-digit">
                                        <h2 class="s-46 statistic-number color--theme">2<span>x</span></h2>
                                    </div>
                                    <!-- Text -->
                                    <div class="block-txt">
                            ...
                            <div id="hd-1-2" class="animate__animated animate__fadeInUp">
                                <div class="hero-digits-block">
                                    <!-- Digit -->
                                    <div class="block-digit">
                                        <h2 class="s-46 statistic-number color--theme">63<span>%</span></h2>
                                    </div>
                                    <!-- Text -->
                                    <div class="block-txt">
