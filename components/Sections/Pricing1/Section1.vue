        ...
        <div class="container">
            ...
            <div class="pricing-1-wrapper">
                <div class="row row-cols-1 row-cols-md-3">
                    <!-- STARTER PLAN -->
                    <div class="col">
                        <div id="pt-1-1" class="p-table pricing-1-table bg--white-100 block-shadow r-12 animate__animated animate__fadeInUp">
                            <!-- TABLE HEADER -->
                            <div class="pricing-table-header">
                                ...
                                <!-- Price -->
                                <div class="price">
                                    <sup class="color--theme">$</sup>
                                    <span class="color--theme">0</span>
                            ...
                            <!-- END TABLE HEADER -->
                            <!-- PRICING FEATURES -->
                            <ul class="pricing-features color--theme ico-10 ico--green mt-25">
                                <li>
                    ...
                    <!-- BASIC PLAN -->
                    <div class="col">
                        <div id="pt-1-2" class="p-table pricing-1-table bg--white-100 block-shadow r-12 animate__animated animate__fadeInUp">
                            <!-- TABLE HEADER -->
                            <div class="pricing-table-header">
                                <!-- Title -->
                                ...
                                <div class="price">
                                    ...
                                    <div class="price2" v-if="showPrice2">
                                        <sup class="color--theme">$</sup>
                                        <span class="color--theme">16.99</span>
                                        <sup class="validity color--grey">&nbsp;/&ensp;mo</sup>
                                    </div>
                                    <!-- Yearly Price -->
                                    <div class="price1" v-if="showPrice1">
                                        <sup class="color--theme">$</sup>
                                        <span class="color--theme">142.75</span>
                                        <sup class="validity color--grey">&nbsp;/&ensp;yr</sup>
                                        <!-- Discount Badge -->
                                        <div class="pricing-discount bg--yellow-400 color--theme r-36">
                    ...
                    <!-- ADVANCED PLAN -->
                    <div class="col">
                        <div id="pt-1-3" class="p-table pricing-1-table bg--white-100 block-shadow r-12 animate__animated animate__fadeInUp">
                            <!-- TABLE HEADER -->
                            <div class="pricing-table-header">
                                <!-- Title -->
                                ...
                                <div class="price">
                                    ...
                                    <div class="price2" v-if="showPrice2">
                                        <sup class="color--theme">$</sup>
                                        <span class="color--theme">24.99</span>
                                        <sup class="validity color--grey">&nbsp;/&ensp;mo</sup>
                                    </div>
                                    <!-- Yearly Price -->
                                    <div class="price1" v-if="showPrice1">
                                        <sup class="color--theme">$</sup>
                                        <span class="color--theme">194.99</span>
                                        <sup class="validity color--grey">&nbsp;/&ensp;yr</sup>
                                        <!-- Discount Badge -->
                                        <div class="pricing-discount bg--yellow-400 color--theme r-36">
