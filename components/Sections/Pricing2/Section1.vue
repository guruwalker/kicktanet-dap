                            ...
                            <div class="pricing-table-header">
                                ...
                                <div class="price mt-25">
                                    ...
                                    <div class="price2" v-if="showPrice2">
                                        <sup class="color--theme">$</sup>
                                        <span class="color--theme">3</span>
                                        <sup class="coins color--theme">99</sup>
                                        <sup class="validity color--grey">per month</sup>
                                    </div>
                                    <!-- Yearly Price -->
                                    <div class="price1" v-if="showPrice1">
                                        <sup class="color--theme">$</sup>
                                        <span class="color--theme">35</span>
                                        <sup class="coins color--theme">99</sup>
                        ...
                        <div id="pt-3-3" class="p-table pricing-3-table bg--white-100 block-shadow r-12 animate__animated animate__fadeInUp">
                            ...
                            <div class="pricing-table-header">
                                ...
                                <div class="price mt-25">
                                    ...
                                    <div class="price1" v-if="showPrice1">
                                        <sup class="color--theme">$</sup>
                                        <span class="color--theme">62</span>
                                        <sup class="coins color--theme">99</sup>
                                        <sup class="validity color--grey">per year</sup>
                                    </div>
                                </div>
