                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="color--theme">Up to 2</td>
                                        <td class="color--theme">Up to 250</td>
                                        <td class="color--theme">Unlimited</td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="text-start">Available Storage</th>
                                        <td class="color--theme">2Gb</td>
                                        <td class="color--theme">50Gb</td>
                                        <td class="color--theme">350Gb</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="color--theme">Weekly</td>
                                        <td class="color--theme">Daily</td>
                                        <td class="color--theme">Daily</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr class="table-last-tr">
                                        ...
                                        <td class="color--theme">Limited</td>
                                        <td class="color--theme">Basic</td>
                                        <td class="color--theme">Priority</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="comp-table-payment">
                <div class="row row-cols-1 row-cols-md-3">
                    ...
                    <div class="col col-lg-4">
                        <div id="pbox-2" class="pbox mb-40 animate__animated animate__fadeInUp">
                            <!-- Title -->
                    ...
                    <div class="col col-lg-3">
                        <div id="pbox-3" class="pbox mb-40 animate__animated animate__fadeInUp">
                            <!-- Title -->
