...
const visits = ref([
  {
    ...
    title: "Empowering Women with Digital Skills",
    description:
      "A hands-on training session aimed at equipping women in Mandera with essential digital skills to improve economic opportunities.",
  ...
  <div>
    <section id="visits-page" class="gr--whitesmoke inner-page-hero division">
      ...
      <div class="posts-wrapper mt-4">
        <div v-if="filteredVisits.length" class="row d-flex justify-center">
          <div
          ...
          >
            <NuxtLink
              class="blog-post visit-card mb-40 animate__animated animate__fadeInUp clearfix"
