...
useSeoMeta({
  title: "Component 4 - Partners | KICKTANet DAP",
});
...
const partners = ref([
  {
    ...
    contactPerson: "David Indeje",
    emails: ["dindeje@kictanet.or.ke"],
  },
]);
</script>
...
<template>
  <section id="partners-page" class="gr--whitesmoke inner-page-hero division">
    <div class="container">
      <div class="text-left">
        <p class="s-20 w-700">
          COMPONENT #4- Ensure access to digital technology and platforms,
          including accessible devices and affordable internet
        </p>
